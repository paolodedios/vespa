...
- Use `mvn install` in integration/schema-language-server to build the language server
- If there has been changes elsewhere, run `mvn install` in the root of the repository to rebuild all.
